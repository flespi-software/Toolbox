<template>
  <div>
    ...
    >
      ...
      <template #after-datetime><q-btn  @click="refresh" icon="mdi-refresh" flat round dense /></template>
    </virtual-scroll-list>
  </div>
</template>
...
import { useContainersMessagesStore } from 'src/qvirtualscroll/stores/containersMessages'
...
export default {
  ...
  setup (props) {
     ...
     */
    const listStore = useContainersMessagesStore({
