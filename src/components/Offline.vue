<template>
  <div v-if="$store.state.token && ($store.state.offline || $store.state.socketOffline)" class="offline-page window-height window-width bg-light column items-center no-wrap">
...
<style lang="stylus">
  .offline-page
    ...
    z-index 10020
    opacity .7
    background-image url(../../public/toolbox.png)
    .offline-back
      width 100%
      height 100vh
      overflow hidden
