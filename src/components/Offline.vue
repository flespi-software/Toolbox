<template>
  <div v-if="mainStore.token && (mainStore.offline || mainStore.socketOffline)" class="offline-page window-height window-width bg-light column items-center no-wrap">
...
export default {
  ...
  created () {
    this.intervalId = setInterval(() => { this.mainStore.checkConnection() }, 5000)
  },
  beforeUnmount () {
