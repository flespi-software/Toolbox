<template>
  <div class="login-page window-height window-width bg-light column items-center no-wrap">
    <a v-if="!$q.platform.is.mobile || !$q.platform.within.iframe" href="https://github.com/flespi-software/Toolbox/" target="_blank"><img class="absolute-top-right" style="border: 0; width: 149px; height: 149px;" src="right-graphite@2x.png" alt="Fork me on GitHub"></a>
    <div class="login-back flex items-center justify-center">
      <div class="login-code flex justify-center">
        <img style="max-width: 80vw;" :style="{ maxHeight: $q.platform.is.mobile ? '80px' : '18vw' }" src="toolbox.png" alt="Toolbox">
