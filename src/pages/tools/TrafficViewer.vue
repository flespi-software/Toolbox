...
<script>
import TrafficViewer from '../../components/trafficViewer/channels/Index.vue'
...
export default {
  ...
  computed: {
    ...
    items () {
      return Object.values(this.mainStore.channels || {}).filter(item => this.mainStore.channelsProtocols[item.protocol_id].features.raw_packets)
    },
    filteredItems () {
