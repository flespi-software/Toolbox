...
<script>
import HexViewer from '../../components/hexViewer/Index.vue'
...
export default {
  ...
  computed: {
    ...
    items () { return Object.values(this.mainStore.channels || {}).filter(item => this.PROXY_PROTOCOL_ID && item.protocol_id === this.PROXY_PROTOCOL_ID) },
    filteredItems () {
