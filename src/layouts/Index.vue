...
export default {
  data () {
    return {
      ...
      connectFlag: false,
      isTabsVisible: true,
      entityByGroup: ['platform', 'webhooks', 'realms', 'grants', 'channels', 'devices', 'groups', 'streams', 'calcs', 'intervals', 'plugins', 'hexViewer', 'trafficViewer', 'deviceTraffic', 'streamTraffic', 'modems', 'containers', 'cdns', 'mqtt', 'mqttClient'],
      isNeedSelect: true,
      entityInited: false,
